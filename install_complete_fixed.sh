...
# 🚀 ComfyUI Custom Nodes - Instalador Completo Automático (CORREGIDO)
# 👨‍💻 Desarrollado por: chelogarcho
# 🌍 Funciona desde cualquier ubicación
# ✅ Corregido para estructuras existentes
...
echo -e "${BLUE}✅ CORREGIDO para estructuras existentes${NC}"
echo ""
...
# Función para verificar si es ComfyUI válido (CORREGIDA)
verify_comfyui() {
    local dir="$1"
